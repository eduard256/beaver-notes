      ...
      >
        ...
        <div className="msg-footer">
          ...
          <AnimatePresence>
            {showActions && (
              ...
              >
                ...
                <button className="msg-action-btn msg-action-btn--danger" onClick={handleDelete} title="Удалить">
          ...
          <div className="msg-actions-mobile">
            ...
            <button className="msg-action-btn msg-action-btn--danger" onClick={handleDelete}>
